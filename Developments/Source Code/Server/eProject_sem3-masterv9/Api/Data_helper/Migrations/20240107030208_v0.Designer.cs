            ...
            modelBuilder.Entity("Lib.Entities.ImportReceipt", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Status = "Done",
                            Storage_id = 1,
                            Time = new DateTime(2024, 1, 7, 10, 2, 8, 603, DateTimeKind.Local).AddTicks(8150)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Status = "Done",
                            Storage_id = 1,
                            Time = new DateTime(2024, 1, 7, 10, 2, 8, 603, DateTimeKind.Local).AddTicks(8170)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            Status = "Done",
                            Storage_id = 1,
                            Time = new DateTime(2024, 1, 7, 10, 2, 8, 603, DateTimeKind.Local).AddTicks(8180)
                        },
                        new
                        {
                            Id = 4,
                        ...
                        new
                        {
                            ...
                            Status = "Done",
                            Storage_id = 1,
                            Time = new DateTime(2024, 1, 7, 10, 2, 8, 603, DateTimeKind.Local).AddTicks(8190)
                        },
                        new
                        {
                            Id = 9,
                        ...
                        new
                        {
                            ...
                            Status = "Done",
                            Storage_id = 1,
                            Time = new DateTime(2024, 1, 7, 10, 2, 8, 603, DateTimeKind.Local).AddTicks(8240)
                        },
                        new
                        {
                            Id = 12,
                        ...
                        new
                        {
                            ...
                            Status = "Done",
                            Storage_id = 1,
                            Time = new DateTime(2024, 1, 7, 10, 2, 8, 603, DateTimeKind.Local).AddTicks(8250)
                        },
                        new
                        {
                            Id = 17,
            ...
            modelBuilder.Entity("Lib.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 177, 184, 149, 9, 172, 56, 200, 20, 91, 138, 80, 154, 24, 23, 249, 92, 48, 93, 174, 183, 155, 191, 215, 86, 229, 53, 234, 69, 140, 199, 192, 48, 166, 151, 55, 160, 5, 0, 147, 182, 172, 116, 131, 99, 166, 206, 75, 46, 195, 183, 81, 38, 116, 182, 2, 62, 132, 36, 251, 228, 8, 83, 127, 117 },
                            PasswordSalt = new byte[] { 84, 170, 190, 154, 44, 68, 165, 241, 245, 173, 187, 104, 70, 55, 125, 49, 231, 158, 1, 89, 198, 58, 13, 199, 234, 83, 37, 67, 154, 42, 81, 119, 241, 38, 144, 124, 115, 162, 6, 219, 140, 165, 224, 2, 22, 171, 33, 49, 220, 177, 152, 159, 140, 66, 171, 145, 218, 216, 187, 137, 126, 183, 107, 148, 68, 171, 31, 39, 131, 83, 15, 152, 119, 54, 172, 209, 6, 88, 10, 19, 101, 170, 126, 32, 4, 25, 43, 12, 140, 71, 190, 174, 194, 144, 198, 159, 102, 76, 114, 52, 238, 0, 109, 249, 209, 239, 72, 117, 17, 90, 38, 245, 7, 196, 254, 21, 114, 95, 250, 108, 165, 29, 43, 251, 55, 70, 59, 12 },
                            Phone = "0932859395",
                            RefreshToken = "",
                            Role = "user"
                        },
