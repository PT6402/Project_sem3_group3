    ...
    new Product
    {
        ...
        Numb_Connect = 15
            ...
            modelBuilder.Entity<User>(entity =>
            {
                entity.HasData
                (
                    new User { Id = 1, FullName = "Nguyen Van Thien", Phone = "0932859395", PasswordHash = pass.PasswordHash, PasswordSalt = pass.PasswordSalt, Role = "user" },
            ...
            modelBuilder.Entity<Addresses>().HasData(
                    new Addresses { Id = 1, Address_full = "tuyen quang, ha hang, thuong giap", Phone_code = "207", Province_code = "8", District_code = "72", Ward_code = "2230" },
                    new Addresses { Id = 2, Address_full = "quang ninh , huyen binh lieu, dong van", Phone_code = "203", Province_code = "22", District_code = "198", Ward_code = "6847" },
                    ...
                    new Addresses { Id = 4, Address_full = "cao bang , bao lac , thuong ha", Phone_code = "206", Province_code = "4", District_code = "43", Ward_code = "1327" }
                );
